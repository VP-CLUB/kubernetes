...
spec:
  ...
  template:
    ...
    spec:
      ...
      containers:
      - name: kubedns
        image: hub.docker.vpclub.cn/vpclub_containers/kubedns-amd64:1.7
        resources:
        ...
        - containerPort: 10053
          ...
          protocol: TCP
      - name: dnsmasq
        image: hub.docker.vpclub.cn/vpclub_containers/kube-dnsmasq-amd64:1.3
        args:
        - --cache-size=1000
        - --no-resolv
        ...
        - containerPort: 53
          ...
          protocol: TCP
      - name: healthz
        image: hub.docker.vpclub.cn/vpclub_containers/exechealthz-amd64:1.1
        resources:
